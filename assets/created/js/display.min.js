...
$(document).ready(function() {
        ...
        if (keycode == '13') {
            ...
            $.ajax({
                ...
                success: function (e) {
                    ...
                    var divComments = input.closest(".divComments"),
                    divFormComments = $('.divFormComments', divComments);
                    $(".divFormComments", divComments).css("background" , "#27ae60");
    ...
    $(".formNotedKeywordList").on("change" , function(e) {
        ...
        if(selector.length === 0 || !(selector.attr("id")) ){
            console.log("no commun issue , not possible");
            return;
        }
    ...
    $(document).on("click", ".removeInfoMessage",  function(){
        $(".infoMessage").remove();
        $("body").children().css({
            filter : "",
            opacity : ""
    ...
    $(".magicButton").on("click" , function(){
        ...
        $("body").append("<span class='glyphicon glyphicon-remove removeInfoMessage' style='display: inline-block'></span>")
        var delaySetTimeOut = 0;
        var nb = $(this).attr("data-id"),
            ...
            currentKwdsList.each(function(index, value){
                ...
                if(type === "method"){
                        ...
                        .each(function (index, value) {
                            ...
                            $("input:checked", otherMethod).parents(".btn").each(function(index, value){
                                ...
                                if ((currentWord === otherWord) && (arr.indexOf(otherWord) <= -1) && (!currentScore && currentScore!= 0) && (otherScore)) {
                                    arr.push(otherWord);
                                    delaySetTimeOut = delaySetTimeOut + 430;
                                    ...
                                    setTimeout(function() {
                                        ...
                                        $(".infoMessage").html( nbMatch + " mot(s) traité(s) !");

								    }, delaySetTimeOut);
                                }
                                if((cuKwdsIndex ===  (currentKwdsList.length - 1)) && (otherKwdsIndex === (otherKwdsList.length - 1)) && (otherKwKwdsIndex === ($("input:checked", otherMethod).length - 1))){
                                    $(".infoMessage").html( nbMatch + " mot(s) traité(s) !").delay(delaySetTimeOut+400).fadeOut(450 ,function() {
                                        $(this).remove();
                                        $(".removeInfoMessage").remove();
                                        $("body").children().css({
                                            filter : "",
                                            opacity : ""
                                        });
                    ...
                    otherKwdsList
                        ...
                        .each(function(index, value){
                            ...
                            if((cuKwdsIndex ===  (currentKwdsList.length - 1)) && (otherKwdsIndex === (otherKwdsList.length - 1)) ){
                                $(".infoMessage").html( nbMatch + " mot(s) traité(s) !").delay(delaySetTimeOut+400).fadeOut(450 ,function() {
                                    $(this).remove();
                                    $(".removeInfoMessage").remove();
                                    $("body").children().css({
                ...
                $(".infoMessage").html( nbMatch + " mot(s) traité(s) !").delay(5000).fadeOut(450 ,function() {
                    $(this).remove();
                    $(".removeInfoMessage").remove();
                    $("body").children().css({
                        filter : "",
